...
/// FloatingIpDroplet : The Droplet that the floating IP has been assigned to. When you query a floating IP, if it is assigned to a Droplet, the entire Droplet object will be returned. If it is not assigned, the value will be null.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FloatingIpDroplet {
    ...
    pub kernel: Option<Box<crate::models::Kernel>>,
    ...
    #[serde(rename = "backup_ids")]
    pub backup_ids: Vec<i32>,
    #[serde(rename = "next_backup_window")]
    pub next_backup_window: Option<Box<crate::models::DropletNextBackupWindow>>,
    /// An array of snapshot IDs of any snapshots created from the Droplet instance.
    #[serde(rename = "snapshot_ids")]
    pub snapshot_ids: Vec<i32>,
    #[serde(rename = "image")]
    ...
    #[serde(rename = "volume_ids")]
    pub volume_ids: Vec<String>,
    #[serde(rename = "size")]
    pub size: Box<crate::models::Size>,
    /// The unique slug identifier for the size of this Droplet.
    #[serde(rename = "size_slug")]
    pub size_slug: String,
    #[serde(rename = "networks")]
    pub networks: Box<crate::models::DropletNetworks>,
    #[serde(rename = "region")]
    ...
    #[serde(rename = "vpc_uuid", skip_serializing_if = "Option::is_none")]
    pub vpc_uuid: Option<String>,
}

impl FloatingIpDroplet {
    ...
    pub fn new(id: i32, name: String, memory: i32, vcpus: i32, disk: i32, locked: bool, status: Status, created_at: String, features: Vec<String>, backup_ids: Vec<i32>, next_backup_window: Option<crate::models::DropletNextBackupWindow>, snapshot_ids: Vec<i32>, image: crate::models::Image, volume_ids: Vec<String>, size: crate::models::Size, size_slug: String, networks: crate::models::DropletNetworks, region: crate::models::Region, tags: Vec<String>) -> FloatingIpDroplet {
        FloatingIpDroplet {
            id,
            name,
            memory,
            ...
            features,
            backup_ids,
            next_backup_window: if let Some(x) = next_backup_window {Some(Box::new(x))} else {None},
            snapshot_ids,
            image: Box::new(image),
            volume_ids,
            size: Box::new(size),
