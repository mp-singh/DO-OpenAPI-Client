...
pub struct LoadBalancer {
    ...
    pub region: Option<Box<serde_json::Value>>,
    /// An array containing the IDs of the Droplets assigned to the load balancer.
    #[serde(rename = "droplet_ids", skip_serializing_if = "Option::is_none")]
...
impl LoadBalancer {
    pub fn new(forwarding_rules: Vec<crate::models::ForwardingRule>) -> LoadBalancer {
        LoadBalancer {
            id: None,
            name: None,
            ip: None,
