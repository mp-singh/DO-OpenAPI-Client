...
pub struct DatabasesCreateClusterRequest {
    ...
    #[serde(rename = "private_network_uuid", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "db_names", skip_serializing_if = "Option::is_none")]
    pub db_names: Option<Vec<String>>,
    #[serde(rename = "connection", skip_serializing_if = "Option::is_none")]
    pub connection: Option<Box<crate::models::DatabaseClusterConnection>>,
    #[serde(rename = "private_connection", skip_serializing_if = "Option::is_none")]
    pub private_connection: Option<Box<crate::models::DatabaseClusterConnection>>,
    #[serde(rename = "users", skip_serializing_if = "Option::is_none")]
    pub users: Option<Vec<crate::models::DatabaseUser>>,
    #[serde(rename = "maintenance_window", skip_serializing_if = "Option::is_none")]
    pub maintenance_window: Option<Box<crate::models::DatabaseClusterMaintenanceWindow>>,
    /// The ID of the project that the database cluster is assigned to. If excluded when creating a new database cluster, it will be assigned to your default project.
    #[serde(rename = "project_id", skip_serializing_if = "Option::is_none")]
    pub project_id: Option<uuid::Uuid>,
    #[serde(rename = "rules", skip_serializing_if = "Option::is_none")]
    pub rules: Option<Vec<crate::models::FirewallRule>>,
    #[serde(rename = "backup_restore", skip_serializing_if = "Option::is_none")]
    pub backup_restore: Option<Box<crate::models::DatabaseBackup>>,
}

impl DatabasesCreateClusterRequest {
    pub fn new(name: String, engine: Engine, num_nodes: i32, size: String, region: String) -> DatabasesCreateClusterRequest {
