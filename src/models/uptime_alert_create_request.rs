...
pub struct UptimeAlertCreateRequest {
    ...
    pub notifications: Box<crate::models::Notification>,
    /// Period of time the threshold must be exceeded to trigger the alert.
    #[serde(rename = "period", skip_serializing_if = "Option::is_none")]
    pub period: Option<Period>,
}

impl UptimeAlertCreateRequest {
    pub fn new(name: String, r#type: RHashType, notifications: crate::models::Notification) -> UptimeAlertCreateRequest {
...
pub enum RHashType {
    ...
    #[serde(rename = "down")]
    Down,
    #[serde(rename = "down_global")]
    DownGlobal,
    #[serde(rename = "ssl_expiry")]
    SslExpiry,
}
