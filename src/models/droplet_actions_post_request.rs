...
#[serde(tag = "r#type")]
pub enum DropletActionsPostRequest {
    #[serde(rename="change_kernel")]
    DropletActionChangeKernel {
        /// A unique number used to identify and reference a specific kernel.
        #[serde(rename = "kernel", skip_serializing_if = "Option::is_none")]
        kernel: Option<i32>,
    },
    #[serde(rename="disable_backups")]
    DropletAction {
    },
    #[serde(rename="enable_backups")]
    DropletAction {
    },
    ...
    DropletActionRebuild {
        ...
        image: Option<Box<crate::models::OneOfLessThanStringCommaIntegerGreaterThan>>,
    },
    #[serde(rename="rename")]
    DropletActionRename {
