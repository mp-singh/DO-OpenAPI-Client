...
pub struct AppServiceSpec {
    ...
    pub git: Option<Box<crate::models::AppsGitSourceSpec>>,
    #[serde(rename = "github", skip_serializing_if = "Option::is_none")]
    pub github: Option<Box<crate::models::AppsGithubSourceSpec>>,
    #[serde(rename = "gitlab", skip_serializing_if = "Option::is_none")]
    pub gitlab: Option<Box<crate::models::AppsGitlabSourceSpec>>,
    #[serde(rename = "image", skip_serializing_if = "Option::is_none")]
    pub image: Option<Box<crate::models::AppsImageSourceSpec>>,
    ...
    #[serde(rename = "run_command", skip_serializing_if = "Option::is_none")]
    pub run_command: Option<String>,
    /// An optional path to the working directory to use for the build. For Dockerfile builds, this will be used as the build context. Must be relative to the root of the repo.
    #[serde(rename = "source_dir", skip_serializing_if = "Option::is_none")]
    pub source_dir: Option<String>,
    /// A list of environment variables made available to the component.
    #[serde(rename = "envs", skip_serializing_if = "Option::is_none")]
    pub envs: Option<Vec<crate::models::AppVariableDefinition>>,
    ...
    #[serde(rename = "environment_slug", skip_serializing_if = "Option::is_none")]
    pub environment_slug: Option<String>,
    #[serde(rename = "log_destinations", skip_serializing_if = "Option::is_none")]
    pub log_destinations: Option<Box<crate::models::AppLogDestinationDefinition>>,
    /// The amount of instances that this component should be scaled to. Default: 1
    #[serde(rename = "instance_count", skip_serializing_if = "Option::is_none")]
    pub instance_count: Option<i64>,
    /// The instance size to use for this component. Default: `basic-xxs`
    #[serde(rename = "instance_size_slug", skip_serializing_if = "Option::is_none")]
    pub instance_size_slug: Option<InstanceSizeSlug>,
    #[serde(rename = "cors", skip_serializing_if = "Option::is_none")]
    pub cors: Option<Box<crate::models::AppsCorsPolicy>>,
    #[serde(rename = "health_check", skip_serializing_if = "Option::is_none")]
    pub health_check: Option<Box<crate::models::AppServiceSpecHealthCheck>>,
    ...
    #[serde(rename = "internal_ports", skip_serializing_if = "Option::is_none")]
    ...
    pub routes: Option<Vec<crate::models::AppRouteSpec>>,
}

impl AppServiceSpec {
    pub fn new(name: String) -> AppServiceSpec {
        AppServiceSpec {
            name,
            git: None,
            github: None,
...
pub enum InstanceSizeSlug {
    #[serde(rename = "basic-xxs")]
    BasicXxs,
    #[serde(rename = "basic-xs")]
    BasicXs,
    #[serde(rename = "basic-s")]
    BasicS,
    #[serde(rename = "basic-m")]
    BasicM,
    #[serde(rename = "professional-xs")]
    ProfessionalXs,
    #[serde(rename = "professional-s")]
    ProfessionalS,
    #[serde(rename = "professional-m")]
    ProfessionalM,
    #[serde(rename = "professional-1l")]
    Professional1l,
    #[serde(rename = "professional-l")]
    ProfessionalL,
    #[serde(rename = "professional-xl")]
    ProfessionalXl,
}

impl Default for InstanceSizeSlug {
    fn default() -> InstanceSizeSlug {
        Self::BasicXxs
    }
}
