...
/// ReservedIpDroplet : The Droplet that the reserved IP has been assigned to. When you query a reserved IP, if it is assigned to a Droplet, the entire Droplet object will be returned. If it is not assigned, the value will be null.



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ReservedIpDroplet {
