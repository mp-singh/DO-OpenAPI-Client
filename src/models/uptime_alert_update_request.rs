...
pub struct UptimeAlertUpdateRequest {
    ...
    pub notifications: Option<Box<crate::models::Notification>>,
    /// Period of time the threshold must be exceeded to trigger the alert.
    #[serde(rename = "period", skip_serializing_if = "Option::is_none")]
    pub period: Option<Period>,
}

impl UptimeAlertUpdateRequest {
    pub fn new() -> UptimeAlertUpdateRequest {
        UptimeAlertUpdateRequest {
            name: None,
            r#type: None,
            threshold: None,
            comparison: None,
