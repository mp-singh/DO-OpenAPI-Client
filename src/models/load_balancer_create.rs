...
pub struct LoadBalancerCreate {
    ...
    pub droplet_ids: Vec<i32>,
    #[serde(rename = "region")]
    pub region: crate::models::RegionSlug,
    ...
    #[serde(rename = "size_unit", skip_serializing_if = "Option::is_none")]
    ...
    pub forwarding_rules: Vec<crate::models::ForwardingRule>,
    ...
    pub sticky_sessions: Option<Box<crate::models::StickySessions>>,
    /// A boolean value indicating whether HTTP requests to the load balancer on port 80 will be redirected to HTTPS on port 443.
    #[serde(rename = "redirect_http_to_https", skip_serializing_if = "Option::is_none")]
    pub redirect_http_to_https: Option<bool>,
    /// A boolean value indicating whether PROXY Protocol is in use.
    #[serde(rename = "enable_proxy_protocol", skip_serializing_if = "Option::is_none")]
    pub enable_proxy_protocol: Option<bool>,
    /// A boolean value indicating whether HTTP keepalive connections are maintained to target Droplets.
    #[serde(rename = "enable_backend_keepalive", skip_serializing_if = "Option::is_none")]
    pub enable_backend_keepalive: Option<bool>,
    /// A string specifying the UUID of the VPC to which the load balancer is assigned.
    #[serde(rename = "vpc_uuid", skip_serializing_if = "Option::is_none")]
    pub vpc_uuid: Option<uuid::Uuid>,
    ...
    #[serde(rename = "disable_lets_encrypt_dns_records", skip_serializing_if = "Option::is_none")]
    pub disable_lets_encrypt_dns_records: Option<bool>,
}

impl LoadBalancerCreate {
    pub fn new(droplet_ids: Vec<i32>, region: crate::models::RegionSlug, forwarding_rules: Vec<crate::models::ForwardingRule>) -> LoadBalancerCreate {
        LoadBalancerCreate {
            droplet_ids,
            region,
            id: None,
            ...
            enable_backend_keepalive: None,
            vpc_uuid: None,
            disable_lets_encrypt_dns_records: None,
        }
    }
}
...
pub enum Size {
    #[serde(rename = "lb-small")]
    Small,
    #[serde(rename = "lb-medium")]
    Medium,
    #[serde(rename = "lb-large")]
    Large,
}
