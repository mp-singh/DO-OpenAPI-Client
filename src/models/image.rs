...
pub struct Image {
    ...
    pub distribution: Option<crate::models::Distribution>,
    ...
    pub regions: Option<Vec<crate::models::RegionSlug>>,
    ...
    #[serde(rename = "size_gigabytes", skip_serializing_if = "Option::is_none")]
