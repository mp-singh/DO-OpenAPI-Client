...
/// struct for typed errors of method [`projects_get_default`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ProjectsGetDefaultError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`projects_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ProjectsPatchError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`projects_patch_default`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ProjectsPatchDefaultError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`projects_update_default`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ProjectsUpdateDefaultError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
pub async fn projects_create(configuration: &configuration::Configuration, projects_create_request: crate::models::ProjectsCreateRequest) -> Result<crate::models::ProjectsCreate201Response, Error<ProjectsCreateError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&projects_create_request);
...
pub async fn projects_delete(configuration: &configuration::Configuration, project_id: &str) -> Result<(), Error<ProjectsDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/projects/{project_id}", local_var_configuration.base_path, project_id=crate::apis::urlencode(project_id));
...
pub async fn projects_get(configuration: &configuration::Configuration, project_id: &str) -> Result<crate::models::ProjectsCreate201Response, Error<ProjectsGetError>> {
    let local_var_configuration = configuration;
...
pub async fn projects_get_default(configuration: &configuration::Configuration, ) -> Result<crate::models::ProjectsGetDefault200Response, Error<ProjectsGetDefaultError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/projects/default", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectsGetDefaultError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn projects_list(configuration: &configuration::Configuration, ) -> Result<crate::models::ProjectsList200Response, Error<ProjectsListError>> {
    let local_var_configuration = configuration;
...
pub async fn projects_patch(configuration: &configuration::Configuration, project_id: &str, project: crate::models::Project) -> Result<crate::models::ProjectsCreate201Response, Error<ProjectsPatchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectsPatchError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn projects_patch_default(configuration: &configuration::Configuration, project: crate::models::Project) -> Result<crate::models::ProjectsCreate201Response, Error<ProjectsPatchDefaultError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectsPatchDefaultError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn projects_update(configuration: &configuration::Configuration, project_id: &str, projects_update_default_request: crate::models::ProjectsUpdateDefaultRequest) -> Result<crate::models::ProjectsCreate201Response, Error<ProjectsUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&projects_update_default_request);
...
pub async fn projects_update_default(configuration: &configuration::Configuration, projects_update_default_request: crate::models::ProjectsUpdateDefaultRequest) -> Result<crate::models::ProjectsCreate201Response, Error<ProjectsUpdateDefaultError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ProjectsUpdateDefaultError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
