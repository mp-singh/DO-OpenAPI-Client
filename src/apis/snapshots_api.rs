...
/// struct for typed errors of method [`snapshots_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SnapshotsDeleteError {
...
/// struct for typed errors of method [`snapshots_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SnapshotsGetError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`snapshots_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SnapshotsListError {
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
    DefaultResponse(crate::models::Error),
...
pub async fn snapshots_delete(configuration: &configuration::Configuration, snapshot_id: SnapshotsGetSnapshotIdParameter) -> Result<(), Error<SnapshotsDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/snapshots/{snapshot_id}", local_var_configuration.base_path, snapshot_id=snapshot_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SnapshotsDeleteError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn snapshots_get(configuration: &configuration::Configuration, snapshot_id: SnapshotsGetSnapshotIdParameter) -> Result<crate::models::SnapshotsGet200Response, Error<SnapshotsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SnapshotsGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn snapshots_list(configuration: &configuration::Configuration, per_page: Option<i32>, page: Option<i32>, resource_type: Option<&str>) -> Result<crate::models::SnapshotsList200Response, Error<SnapshotsListError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/snapshots", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SnapshotsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
