...
/// struct for typed errors of method [`reserved_ips_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpsCreateError {
...
/// struct for typed errors of method [`reserved_ips_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpsDeleteError {
    Status401(crate::models::Error),
...
/// struct for typed errors of method [`reserved_ips_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpsGetError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`reserved_ips_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReservedIpsListError {
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
    DefaultResponse(crate::models::Error),
...
pub async fn reserved_ips_create(configuration: &configuration::Configuration, reserved_ip_create: crate::models::ReservedIpCreate) -> Result<crate::models::ReservedIpsCreate202Response, Error<ReservedIpsCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/reserved_ips", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&reserved_ip_create);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReservedIpsCreateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn reserved_ips_delete(configuration: &configuration::Configuration, reserved_ip: &str) -> Result<(), Error<ReservedIpsDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/reserved_ips/{reserved_ip}", local_var_configuration.base_path, reserved_ip=crate::apis::urlencode(reserved_ip));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReservedIpsDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reserved_ips_get(configuration: &configuration::Configuration, reserved_ip: &str) -> Result<crate::models::ReservedIpsGet200Response, Error<ReservedIpsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReservedIpsGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reserved_ips_list(configuration: &configuration::Configuration, ) -> Result<crate::models::ReservedIpsList200Response, Error<ReservedIpsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReservedIpsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
