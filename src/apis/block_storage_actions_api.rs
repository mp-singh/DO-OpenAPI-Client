...
/// struct for typed errors of method [`volume_actions_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VolumeActionsGetError {
...
/// struct for typed errors of method [`volume_actions_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VolumeActionsListError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`volume_actions_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VolumeActionsPostError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`volume_actions_post_by_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum VolumeActionsPostByIdError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
pub async fn volume_actions_get(configuration: &configuration::Configuration, volume_id: &str, action_id: i32, per_page: Option<i32>, page: Option<i32>) -> Result<crate::models::VolumeActionsPost202Response, Error<VolumeActionsGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/volumes/{volume_id}/actions/{action_id}", local_var_configuration.base_path, volume_id=crate::apis::urlencode(volume_id), action_id=action_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VolumeActionsGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn volume_actions_list(configuration: &configuration::Configuration, volume_id: &str, per_page: Option<i32>, page: Option<i32>) -> Result<crate::models::VolumeActionsList200Response, Error<VolumeActionsListError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/volumes/{volume_id}/actions", local_var_configuration.base_path, volume_id=crate::apis::urlencode(volume_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VolumeActionsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn volume_actions_post(configuration: &configuration::Configuration, volume_actions_post_request: crate::models::VolumeActionsPostRequest, per_page: Option<i32>, page: Option<i32>) -> Result<crate::models::VolumeActionsPost202Response, Error<VolumeActionsPostError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/volumes/actions", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&volume_actions_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VolumeActionsPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn volume_actions_post_by_id(configuration: &configuration::Configuration, volume_id: &str, volume_actions_post_by_id_request: crate::models::VolumeActionsPostByIdRequest, per_page: Option<i32>, page: Option<i32>) -> Result<crate::models::VolumeActionsPost202Response, Error<VolumeActionsPostByIdError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&volume_actions_post_by_id_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VolumeActionsPostByIdError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
