...
/// struct for typed errors of method [`floating_ips_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FloatingIpsCreateError {
...
/// struct for typed errors of method [`floating_ips_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FloatingIpsDeleteError {
    Status401(crate::models::Error),
...
/// struct for typed errors of method [`floating_ips_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FloatingIpsGetError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`floating_ips_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum FloatingIpsListError {
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
    DefaultResponse(crate::models::Error),
...
pub async fn floating_ips_create(configuration: &configuration::Configuration, floating_ip_create: crate::models::FloatingIpCreate) -> Result<crate::models::FloatingIpsCreate202Response, Error<FloatingIpsCreateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/floating_ips", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&floating_ip_create);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FloatingIpsCreateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn floating_ips_delete(configuration: &configuration::Configuration, floating_ip: &str) -> Result<(), Error<FloatingIpsDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/floating_ips/{floating_ip}", local_var_configuration.base_path, floating_ip=crate::apis::urlencode(floating_ip));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FloatingIpsDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn floating_ips_get(configuration: &configuration::Configuration, floating_ip: &str) -> Result<crate::models::FloatingIpsGet200Response, Error<FloatingIpsGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FloatingIpsGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn floating_ips_list(configuration: &configuration::Configuration, ) -> Result<crate::models::FloatingIpsList200Response, Error<FloatingIpsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<FloatingIpsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
