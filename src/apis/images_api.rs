...
/// struct for typed errors of method [`images_create_custom`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ImagesCreateCustomError {
...
/// struct for typed errors of method [`images_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ImagesDeleteError {
    Status401(crate::models::Error),
...
/// struct for typed errors of method [`images_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ImagesListError {
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
    DefaultResponse(crate::models::Error),
...
/// struct for typed errors of method [`images_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ImagesUpdateError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
pub async fn images_create_custom(configuration: &configuration::Configuration, image_new_custom: crate::models::ImageNewCustom) -> Result<crate::models::ImagesCreateCustom202Response, Error<ImagesCreateCustomError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/images", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&image_new_custom);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImagesCreateCustomError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn images_delete(configuration: &configuration::Configuration, image_id: i32) -> Result<(), Error<ImagesDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/images/{image_id}", local_var_configuration.base_path, image_id=image_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImagesDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn images_get(configuration: &configuration::Configuration, image_id: ImagesGetImageIdParameter) -> Result<crate::models::ImagesGet200Response, Error<ImagesGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImagesGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn images_list(configuration: &configuration::Configuration, r#type: Option<&str>, private: Option<bool>, tag_name: Option<&str>, per_page: Option<i32>, page: Option<i32>) -> Result<crate::models::ImagesList200Response, Error<ImagesListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImagesListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn images_update(configuration: &configuration::Configuration, image_id: i32, image_update: crate::models::ImageUpdate) -> Result<crate::models::ImagesGet200Response, Error<ImagesUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&image_update);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImagesUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
