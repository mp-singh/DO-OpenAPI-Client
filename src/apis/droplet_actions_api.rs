...
/// struct for typed errors of method [`droplet_actions_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DropletActionsGetError {
...
/// struct for typed errors of method [`droplet_actions_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DropletActionsListError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`droplet_actions_post`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DropletActionsPostError {
    Status401(crate::models::Error),
    Status404(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
...
/// struct for typed errors of method [`droplet_actions_post_by_tag`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DropletActionsPostByTagError {
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
    DefaultResponse(crate::models::Error),
...
pub async fn droplet_actions_get(configuration: &configuration::Configuration, droplet_id: i32, action_id: i32) -> Result<crate::models::ActionsGet200Response, Error<DropletActionsGetError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/droplets/{droplet_id}/actions/{action_id}", local_var_configuration.base_path, droplet_id=droplet_id, action_id=action_id);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DropletActionsGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn droplet_actions_list(configuration: &configuration::Configuration, droplet_id: i32, per_page: Option<i32>, page: Option<i32>) -> Result<crate::models::ActionsList200Response, Error<DropletActionsListError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/droplets/{droplet_id}/actions", local_var_configuration.base_path, droplet_id=droplet_id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DropletActionsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn droplet_actions_post(configuration: &configuration::Configuration, droplet_id: i32, droplet_actions_post_request: Option<crate::models::DropletActionsPostRequest>) -> Result<crate::models::ActionsGet200Response, Error<DropletActionsPostError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&droplet_actions_post_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DropletActionsPostError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn droplet_actions_post_by_tag(configuration: &configuration::Configuration, tag_name: Option<&str>, droplet_actions_post_by_tag_request: Option<crate::models::DropletActionsPostByTagRequest>) -> Result<crate::models::DropletActionsPostByTag201Response, Error<DropletActionsPostByTagError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/droplets/actions", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    local_var_req_builder = local_var_req_builder.json(&droplet_actions_post_by_tag_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DropletActionsPostByTagError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
