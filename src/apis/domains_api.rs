...
/// struct for typed errors of method [`domains_create`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DomainsCreateError {
...
/// struct for typed errors of method [`domains_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DomainsDeleteError {
    Status401(crate::models::Error),
...
/// struct for typed errors of method [`domains_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DomainsListError {
    Status401(crate::models::Error),
    Status429(crate::models::Error),
    Status500(crate::models::Error),
    DefaultResponse(crate::models::Error),
...
pub async fn domains_create(configuration: &configuration::Configuration, domain: Option<crate::models::Domain>) -> Result<crate::models::DomainsCreate201Response, Error<DomainsCreateError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&domain);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DomainsCreateError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn domains_delete(configuration: &configuration::Configuration, domain_name: &str) -> Result<(), Error<DomainsDeleteError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/v2/domains/{domain_name}", local_var_configuration.base_path, domain_name=crate::apis::urlencode(domain_name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DomainsDeleteError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn domains_get(configuration: &configuration::Configuration, domain_name: &str) -> Result<crate::models::DomainsGet200Response, Error<DomainsGetError>> {
    let local_var_configuration = configuration;
...
pub async fn domains_list(configuration: &configuration::Configuration, ) -> Result<crate::models::DomainsList200Response, Error<DomainsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DomainsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
